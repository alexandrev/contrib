...
type Input struct {
	Metrics []AutoGenerated `md:"appMetrics1"`
}
...
type AppMetrics struct {
	TciAppExecutions         []TciAppExecutions         `md:"tci_app_executions"`
	TciAppInstancesCPU       []TciAppInstancesCPU       `md:"tci_app_instances_cpu"`
	TciAppInstancesMemory    []TciAppInstancesMemory    `md:"tci_app_instances_memory"`
	TciAppSinceLastExecution []TciAppSinceLastExecution `md:"tci_app_since_last_execution"`
}
...
func (i *Input) FromMap(values map[string]interface{}) error {
	...
	println(newValue[0].AppMetrics.TciAppExecutions[0].Value)
	i.Metrics = newValue
	return nil
}
